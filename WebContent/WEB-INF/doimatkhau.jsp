				...
				<form action="doimatkhau" method="post">
					...
					<div class="col-sm-8">
						<div class="input-group">
							...
							<input  id="passwordold_reset" type="password" class="password_old form-control content_input"
					...
					<div class="col-sm-8">
						<div class="input-group">
							...
							<input id="passwordnew_reset" type="password" class="password_new form-control content_input"
					...
					<div class="col-sm-8">
						<div class="input-group">
							...
							<input id="passwordnewconf_reset" type="password" class="password_check form-control content_input"
					...
					<div class="col-sm-6 col-xs-6 text-right">
						<button id="resetpasssubmit" class="btn btn-primary" type="submit">
