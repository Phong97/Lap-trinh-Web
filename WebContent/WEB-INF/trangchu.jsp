		  ...
		  <form action="trangchu" name="Login" class="modal-content animate" method="post">
			...
			<!-- Nơi display thông báo lỗi -->
			  ...
			  <div class="text-center">
				  <button id="loginsubmit" class="btn-login" type="submit">  Đăng Nhập</button>
			  </div>
			</div>
			...
			<div class="modal-body">
			  ...
			  <div>
				...
				<c:if test="${thongbao eq 3}">
			  		<p id="announce2">Đăng ký không thành công.<br/>Mật khẩu phải từ 8-20 kí tự hoặc tên đăng nhập từ 5-20 kí tự!</p>
					<script type="text/javascript">
						$(document).ready(function(){
								   $("#id01").css("display","none");
								   $("#id02").css("display","block");
				...
				<c:if test="${thongbao eq 4 }">
			  		<p id="announce2">Tên đăng nhập không chứa kí tự đặt biệt!</p>
					<script type="text/javascript">
						$(document).ready(function(){
								   $("#id01").css("display","none");
								   $("#id02").css("display","block");
			  ...
			  <div class="text-center">
				  <button id="registersubmit" class="btn btn-login" type="submit">  Đăng Ký</button>
			  </div>
			</div>
			<div class="modal-footer">
				<div class="text-center">
