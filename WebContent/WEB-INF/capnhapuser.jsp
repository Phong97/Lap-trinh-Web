			...
			<c:forEach var="row" items="${result.rows}">
				<form action="capnhapuser" method="post">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon"><i
								...
								<input type="password" id="password_update" class="form-control content_input" placeholder="Password"
					...
					<div class="col-sm-6 col-xs-6 text-right">
						<button id="Confirm_Update" class="btn btn-primary" type="submit">
